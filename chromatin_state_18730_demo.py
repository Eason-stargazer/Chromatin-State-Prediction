...
Original file is located at
    https://colab.research.google.com/drive/1j_79Rf06o8fTjBxN1UifStnkedq1HrHO
"""
...
# GC-balanced / mixed regulatory kmers
"GTCAAC",
"GTTAAC",
"GTTGAC",
"ATGCAAAT",
...
nn_model = models.Sequential([
    ...
    layers.BatchNormalization(), # Added: Stabilizes inputs to the next layer
...
history = nn_model.fit(
    X_train_scaled,
    y_train,
    epochs=13,            # Number of passes through the data (11)
...
disp = ConfusionMatrixDisplay.from_predictions(
    ...
    cmap=plt.cm.Blues,
    xticks_rotation=45, # Rotate labels for better fit
    values_format='.2f', # Show two decimal places for percentages
    normalize='true',    # This makes it easier to spot class-specific issues
    ax=ax
)
